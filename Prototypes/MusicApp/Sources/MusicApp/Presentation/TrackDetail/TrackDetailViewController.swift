...
final class TrackDetailViewController: UIViewController {
    ...
    private func setupLayout() {
        ...
        artworkImageView.backgroundColor = FUIColor.surfaceElevated
        ...
        artistLabel.textColor = FUIColor.textSecondary
        albumLabel.font = Typography.body
        albumLabel.textColor = FUIColor.textSecondary
        genreLabel.font = Typography.caption
        genreLabel.textColor = FUIColor.textDisabled
        durationLabel.font = .monospacedDigitSystemFont(ofSize: 14, weight: .regular)
        durationLabel.textColor = FUIColor.textSecondary
